...
(function($){
    ...
    $.fn.sSelect = function(options){
        return this.each(function(){
            ...
            function newUlPos(){
				var docWrap = (function() {
					if (opts.parentWrapper != "") {
						return $input.closest(opts.parentWrapper);
					} else {
						return $(window);
					}
				})(opts.parentWrapper);
                var containerPosY = $containerDiv.offset().top,
                    docHeight     = docWrap.height(),
                    scrollTop     = docWrap.scrollTop();
